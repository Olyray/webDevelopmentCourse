...
app.post("/submit", (req, res) => {
  ...
  const selectedNoun = noun[Math.floor(Math.random() * noun.length)];
  const selectedAdjective = adj[Math.floor(Math.random() * adj.length)];
  const bandName = selectedNoun + " " + selectedAdjective;
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index.ejs", {chosenName: bandName});
